...
-- Iced Hub theme
local IcedTheme = {
	Accent = Color3.fromRGB(115, 220, 255),
	AccentLight = Color3.fromRGB(185, 240, 255),
	AccentDark = Color3.fromRGB(20, 70, 100),
...
function ChangeSBstate(p175, p176)
	if typeof(p175) == 'Instance' and p175:IsA('SelectionBox') then
		if p176 == 'Anchored' then
			p175.Color3 = Color3.fromRGB(115, 220, 255)
			p175.SurfaceColor3 = Color3.fromRGB(185, 240, 255)
		...
		if u403(v418[2], p417) then
			...
			if p415 == 'LowRank' or p415 == 'HighRank' or p415 == 'Leader' then
				...
				elseif v419 == ':reveal' then
					u24:FireServer('/w ' .. p416 .. " I'm using Iced Hub!", 'All')
...
imageButton.ImageColor3 = Color3.fromRGB(115, 220, 255)
...
imageButtonDe.ImageColor3 = Color3.fromRGB(115, 220, 255)
...
_RunService.RenderStepped:Connect(function()
	if _Circle then
		...
		_Circle.Color = Color3.fromRGB(115, 220, 255)
	...
	if _Circle2 then
		...
		_Circle2.Color = Color3.fromRGB(20, 70, 100)
...
imageButtonTeleport.ImageColor3 = Color3.fromRGB(115, 220, 255)
...
imageButtonControl.ImageColor3 = Color3.fromRGB(115, 220, 255)
...
imageButtonAnchor.ImageColor3 = Color3.fromRGB(115, 220, 255)
